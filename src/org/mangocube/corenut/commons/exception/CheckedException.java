...
public class CheckedException extends Exception {
    ...
    public enum PointAccountError {

		@ErrorCode(comment = "find PointAccount by id fail!{1}")
		FIND_POINTACCOUNT_BY_ID_ERROR,

		@ErrorCode(comment = "create PointAccount fail!")
		ADD_POINTACCOUNT_ERROR,

		@ErrorCode(comment = "update PointAccount fail!")
		UPDATE_POINTACCOUNT_ERROR,

		@ErrorCode(comment = "余额不足!")
		BALANCE_LACK_ERROR,

		@ErrorCode(comment = "操作积分失败!")
		OPER_POINT_ARGS_ERROR,

		@ErrorCode(comment = "当前操作失败，可能存在其他用户在操作该数据!")
		OPER_NOT_SYNCHRONIZATION,
		
		@ErrorCode(comment = "查找数据失败!")
		QUERY_ERROR;

	}
    
    public static void main(String[] args) throws PointServiceException, SecurityException, NoSuchFieldException {
    	ErrorCode errorCode = PointAccountError.class.getField("FIND_POINTACCOUNT_BY_ID_ERROR").getAnnotation(ErrorCode.class);
    	System.out.println(errorCode.comment());
//    	try {
//			throw new Exception("测试异常...");
//		} catch (Exception e) {
//			throw new PointServiceException(
//					PointAccountError.OPER_POINT_ARGS_ERROR, e,
//					new String[]{"3","hello"});
//		}
	}
}
